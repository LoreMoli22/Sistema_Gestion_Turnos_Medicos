"""
Django settings for sistema_gestion_turnos project.
...
SECRET_KEY = 'django-insecure-p$pl$s46tnr-4h2u2ab-28#s4bz33!*s1#yfjnf1$#44oadivp'
...
ROOT_URLCONF = 'sistema_gestion_turnos.urls'
...
WSGI_APPLICATION = 'sistema_gestion_turnos.wsgi.application'
...
EMAIL_HOST_PASSWORD = 'gxwy jdmx zqps kpmh'